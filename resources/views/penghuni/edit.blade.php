                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('penghuni.edit', $penghuni->id) }}"
                            class="{{ request()->routeIs('penghuni.edit') ? 'active' : '' }}">Edit Penghuni</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('penghuni.update', $penghuni->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap"
                            ...
                            value="{{ old('nama_lengkap', $penghuni->nama_lengkap) }}">
                        @error('nama_lengkap')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_telepon" id="nomor_telepon" placeholder="08xxxxx"
                            ...
                            value="{{ old('nomor_telepon', $penghuni->nomor_telepon) }}">
                        @error('nomor_telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_penghuni" id="status_penghuni"
                            ...
                            <option value="kontrak"
                                ...
                                Kontrak</option>
                            <option value="tetap"
                                {{ old('status_penghuni', $penghuni->status_penghuni) == 'tetap' ? 'selected' : '' }}>Tetap
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_menikah" id="status_menikah"
                            ...
                            <option value="menikah"
                                {{ old('status_menikah', $penghuni->status_menikah) == 'menikah' ? 'selected' : '' }}>
                                Menikah</option>
                            <option value="belum menikah"
                                {{ old('status_menikah', $penghuni->status_menikah) == 'belum menikah' ? 'selected' : '' }}>
                    ...
                    <!-- Foto KTP -->
                    <div class="form-group">
                        <label for="foto_ktp">Foto KTP (Jika ingin diubah):</label>
