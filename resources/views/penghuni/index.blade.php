    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Penghuni Management</h6>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="PenghuniTables" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Lengkap</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#PenghuniTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('penghuni.list') }}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    }
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let editUrl = `/master-management/penghuni/${data}/edit`;
                            let showUrl = `/master-management/penghuni/${data}`;
                            return `
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/master-management/penghuni/${id}`,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#PenghuniTables').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Gagal!',
