        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="UsersTables" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#UsersTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('user.list') }}',
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let showUrl = `/user-management/user/${data}`;
                            let editUrl = `/user-management/user/${data}/edit`;
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/user-management/user/${id}`;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#UsersTables').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Gagal!',
