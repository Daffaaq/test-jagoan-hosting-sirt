                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('rumah.edit', $rumah->id) }}"
                            class="{{ request()->routeIs('rumah.edit') ? 'active' : '' }}">Edit Rumah</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('rumah.update', $rumah->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_huni" id="status_huni"
                            ...
                            <option value="dihuni"
                                {{ old('status_huni', $rumah->status_huni) == 'dihuni' ? 'selected' : '' }}>Dihuni</option>
                            <option value="tidak dihuni"
                                {{ old('status_huni', $rumah->status_huni) == 'tidak dihuni' ? 'selected' : '' }}>Tidak
                                Dihuni</option>
                        </select>
                        @error('status_huni')
                            <div class="invalid-feedback">
