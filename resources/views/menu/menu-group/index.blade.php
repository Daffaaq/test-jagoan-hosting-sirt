            ...
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('menu-group.create') }}"
                        ...
                        <i class="fas fa-plus fa-sm text-white-50"></i> Add Menu Group
                    </a>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered" id="MenuGroupsTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#MenuGroupsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let editUrl = `/menu-management/menu-group/${data}/edit`;
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/menu-management/menu-group/${id}`;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#MenuGroupsTable').DataTable().ajax.reload();
