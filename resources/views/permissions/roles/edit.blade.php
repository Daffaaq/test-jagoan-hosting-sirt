                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('role.edit', $role->id) }}"
                            class="{{ request()->routeIs('role.edit') ? 'active' : '' }}">
                            Edit Role
                        </a>
                    </li>
                </ol>
                ...
                <form method="POST" action="{{ route('role.update', $role->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $role->name) }}"
                            placeholder="Role Name" class="form-control @error('name') is-invalid @enderror">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="guard_name" id="guard_name"
                            value="{{ old('guard_name', $role->guard_name) }}" placeholder="Web"
