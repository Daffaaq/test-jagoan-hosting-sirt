                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('permission.index') }}"
                            class="{{ request()->routeIs('permission.index') ? 'active' : '' }}">Role Management</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            let editUrl = `/role-and-permission/permission/${data}/edit`;
        ...
        function confirmDelete(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const url = `/role-and-permission/permission/${id}`;
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#PermissionsTables').DataTable().ajax.reload();
                            } else {
